...
CREATE TABLE ClientesRestritos(
	id INT NOT NULL PRIMARY KEY IDENTITY (1,1),				/*NAO CRIEI AINDA*/
	idCliente INT NOT NULL
...
CREATE TABLE FornecedoresRestritos(
	id INT NOT NULL PRIMARY KEY IDENTITY (1,1),
	idFornecedor INT NOT NULL					/*NAO CRIEI AINDA*/
...
CREATE TABLE ItensVendas(
	...
	CDB NUMERIC(13,0) NOT NULL,			--CORRIJIDO
...
CREATE TABLE Producoes(
	...
	CDB NUMERIC(13,0) NOT NULL,		--CORRIGIDO
	Quantidade INT NOT NULL
);
...
ADD FOREIGN KEY (idCliente) REFERENCES Clientes(idCliente)		--AINDA NAO CRIEI
...
ALTER TABLE ItensVendas											--CORRIGIDO
...
ADD FOREIGN KEY (CDB) REFERENCES Medicamentos(CDB)			--CORRIGIDO
